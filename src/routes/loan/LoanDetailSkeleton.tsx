...
export default function LoanDetailSkeleton({}: Props) {
  return (
    <div className="w-full">
      ...
      <div className="w-full bg-grey-6 rounded-[5px] my-[0.4rem] h-[500px] px-[0.8rem] items-center justify-between flex animate-pulse">
        <div className="flex flex-col w-[80%] items-start justify-start h-[450px] pt-[1rem]">
          <div className="w-[80%] h-[1rem] bg-grey-3 rounded mb-[0.4rem]"></div>
