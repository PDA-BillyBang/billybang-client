...
export default function Pin({
  ...
  return (
    <div
      className="flex flex-col items-start justify-end cursor-pointer bg-transparent absolute select-none bottom-2 hover:-translate-y-1 transition-transform"
